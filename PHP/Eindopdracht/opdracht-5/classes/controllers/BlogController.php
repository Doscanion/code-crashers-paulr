...
class BlogController {
    ...
    public function index($pageNumber = 1) {
        ...
        echo $this->twig->render('index.html.twig', ['posts' => $posts, 'pageNumber' => $pageNumber, 'hasMoreFiles' => $hasMoreFiles, 'sort' => $sortTwig]);
    }
    ...
    public function authorPage() {
        ...
        switch ($action) {
            ...
            default:
                ...
                $sortTwig = $_SESSION['sortPosts'] ?? null;
                $hasMoreFiles = $_SESSION['hasMoreFiles'];
                echo $this->twig->render('userblogposts.html.twig', ['posts' => $posts, 'error' => $error, 'pageNumber' => $pageNumber, 'hasMoreFiles' => $hasMoreFiles, 'author' => $author, 'sort' => $sortTwig]);
                break;
        }
    }
